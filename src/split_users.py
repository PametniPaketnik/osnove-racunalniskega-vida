...
newUser_folder = "../images/User_" + userId #Nova mapa

# Poti do map kjer imamo ze narejene obraze
personDoesNotExist = "../images/FaceDetection/PersonDoesNotExist"
userId_folder = f"../images/FaceDetection/{userId}"

existing_folder = "../images/TrainImages"  # Pot do že obstoječe mape "TrainImages"
